    ...
    for game in selected:
        ...
        if game == "dlt":
            ...
            for key, play in play_types.items():
                ...
                mean_score = sum(play_scores) / len(play_scores)
                ranked_plays[int(key)] = [
                    (candidate | {"pick_count": int(key), "play_name": play["name"]}, score - mean_score)
        ...
        # Every model exposes the same candidate-list contract. Direct-digit lines
